...
{June 2021 - Today}
	...
	{
    Worked on Android and iOS native apps for gas meter field technician via Java/Swift with REST calls to AWS using API Gateway and lambda micro-services.
    ...
    CI/CD features via CodeCommit, CodeBuild, CodePipeline and Code deploy. 
